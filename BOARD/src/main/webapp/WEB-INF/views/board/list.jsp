...
<!-- 			<span style="color:#132c6f; padding:20px; font-size:27px">| 한양또래튜터링 "또링"</span> -->
			...
			<li style="background: #FFFFFF; color:rgb(109,109,109); display:block; font-weight:맑은고딕;
				...
				<li><a href="#">또링 소개</a>
			    	<ul>
			            ...
			            <li><a href="http://localhost:8080/views/board/intro.html">한양또래튜터링 소개</a></li>
		...
		<!-- 본문  -->
		<div style="border:1px solid white; margin:0 100px 50px 100px;padding:30px">
			...
			<section id="container">
				<form role="form" method="get">
					...
					<div class="col-md-offset-3" style="margin:0 auto; text-align:center;">
						<ul class="pagination">
