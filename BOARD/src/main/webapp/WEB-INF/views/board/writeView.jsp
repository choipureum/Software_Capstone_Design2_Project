	...
	<script type="text/javascript">
		...
		function fn_addFile(){
			...
			$(".fileAdd_btn").on("click", function(){
				$("#fileIndex").append("<div><input type='file' name='file_"+(fileIndex++)+"'>"+"</button>"+"<button type='button' style='float:right;' id='fileDelBtn'>"+"삭제"+"</button></div>");
			});
		...
		<div id="root">	
			<section id="container">
				<form name="writeForm" method="post" action="/board/write" enctype="multipart/form-data">
					<table style="bordercolor:white;cellspacing:10;">
						<tbody>
							<c:if test="${member.userId != null}">
								<tr>
									<td>
										<label for="title">제목</label></td>
										<td><input type="text" id="title" name="title" class="chk" placeholder=" [팀명] 주제명 / 형식으로 입력해주세요." size="65"/>
									</td>
								</tr>	
								<tr>
									<td>
										<label for="content">내용</label></td>
										<td><textarea id="content" name="content" class="scrollabletextbox" placeholder="내용을 입력하세요."></textarea>
									</td>
								</tr>
								...
								<tr>
									<td>
										...
										<td><input type="text" id="writer" name="writer" class="chk" title="작성자를 입력하세요." value="${member.userId}" readonly="readonly"/>
									</td>
								</tr>
								...
								<tr>
									<td style="color:black;">						
										<button class="write_btn" type="submit">작성</button>	</td>
									<td>	<button class="fileAdd_btn" type="button">파일추가</button>	
									</td>
								</tr>
								<tr>
									<td></td>
